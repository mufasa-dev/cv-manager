...
// UpdateBasicInto is the resolver for the updateBasicInto field.
func (r *mutationResolver) UpdateBasicInto(ctx context.Context, id string, basicInto *model.BasicInfoInput) (*model.BasicInfo, error) {
	panic(fmt.Errorf("not implemented: UpdateBasicInto - updateBasicInto"))
}

// DeleteBasicInto is the resolver for the deleteBasicInto field.
func (r *mutationResolver) DeleteBasicInto(ctx context.Context, id *string) (bool, error) {
	panic(fmt.Errorf("not implemented: DeleteBasicInto - deleteBasicInto"))
}
